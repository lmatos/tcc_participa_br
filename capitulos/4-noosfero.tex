...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{rails-overview}
...
O Noosfero também utiliza uma arquitetura extensível através do uso de plugins. Essa arquitetura é interessante, pois como dito anteriormente, no Noosfero existem múltiplos ambientes que requerem comportamentos que tenham implementações diferentes %(FOWLER). 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{funcionamentomvc}
	\caption[Relacionamento entre os tipos de conteúdo do Noosfero]{Relacionamento entre os tipos de conteúdo do Noosfero. Extraído de Daniel}
